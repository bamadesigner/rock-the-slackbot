...
Tags: slack, slackbot, chat, collaboration, notifications
...
* Setup Slack notification when a core update is available.
* Setup Slack notification when a plugin update is available.
